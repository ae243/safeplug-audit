...
\begin{enumerate}
\item Set up a web page with the crafted Javascript code, which will send a POST request of the following format to all addresses in the range: \url{http://<IP address>/svc/xspctrl/disableTor} (See Appendix A).
