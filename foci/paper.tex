...
\section{Future Work}
A more in-depth analysis of the performance of the Safeplug would be useful in the future.  The performance of the Safeplug reflects it's usability, and would be helpful in determining the trade-offs of using the device.  Additionally, a greater breadth of privacy measurements would cement Safeplug's position as a useful privacy-preserving technology, or a device that doesn't protect privacy as well as other tools.  
